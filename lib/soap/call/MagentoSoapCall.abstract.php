 ...
 */
abstract class MagentoSoapCall
{
	/**
	...
	{
		return MagentoSoapClient::getInstance();
	}
	...
	public function onExceptionAction(Exception $e)
	{
		 ...
		 */
		if( $e->getMessage() === "Session expired. Try to relogin." )
		{
			/*
			 * token is not valid
			 * 
			 * so renew token
			 */
			MagentoSoapClient::getInstance()->updateToken();
		}
