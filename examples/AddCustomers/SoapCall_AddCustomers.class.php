...
class SoapCall_AddCustomers extends PlentySoapCall
{
	...
	{
		if( !isset(self::$instance) || !(self::$instance instanceof SoapCall_AddCustomers) )
		{
			self::$instance = new SoapCall_AddCustomers();
		}
	...
	public function execute()
	{
		try
		{
			 ...
			 * do soap call
			 */
			$response	=	$this->getPlentySoap()->SetCustomers( $oRequest_AddCustomers->getRequest() );
